...
let total_contributions = GAMES_JSON.reduce( (total, game) => {
...
let num_unfunded = unfunded_games.length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${total_raised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${num_unfunded} game${num_unfunded == 1 ? "" : "s"} remains unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
let description_text = document.createElement("p");
description_text.innerHTML = `${displayStr}`;
descriptionContainer.appendChild(description_text);
